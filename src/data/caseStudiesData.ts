...
export const CASE_STUDIES: CaseStudy[] = [
  {
    id: "cs-01",
    title: "250-Bed Greenfield Multi-Specialty Hospital Development",
    ...
    keyRequirements: [
      ...
      "Full integration of 6 Modular Operation Theatres and 30 ICU beds",
      "Consolidated procurement of 400+ distinct medical equipment lines",
      "Single-source execution accountability without third-party vendor conflicts"
    ],
    solutionsDelivered: [
      "Master civil and MEP engineering coordination",
      "Integrated Medical Gas Pipeline System (MGPS) with liquid oxygen tank",
  ...
  {
    id: "cs-02",
    title: "State Health Mission: 15 District Blood Bank Upgrades",
    ...
    keyRequirements: [
      ...
      "24/7 Redundant temperature monitoring with SMS telemetry alarms",
      "Simultaneous delivery and installation across 15 geographical locations",
      "Comprehensive operator training for medical technicians"
    ],
    solutionsDelivered: [
      "Bulk procurement and staging of -80°C and -40°C cryogenic storage",
      "Automated blood collection and component separation workstations",
  ...
  {
    id: "cs-03",
    title: "50-Acre Civic Educational Campus Infrastructure & Fit-Out",
    ...
    keyRequirements: [
      ...
      "Chemical-resistant laboratory casework and safety ventilation",
      "Commercial kitchen capable of serving 8,000 meals daily",
      "Integrated fire protection and campus security network"
    ],
    solutionsDelivered: [
      "Custom ergonomic desking and auditorium seating deployment",
      "Complete epoxy resin laboratory furniture and fume extraction setup",
  ...
  },
  {
    ...
    keyRequirements: [
      ...
      "Addressable fire safety system with clean-agent server room protection",
      "Over 150,000 sq.ft of premium vitrified tiles and architectural granite",
      "Synchronized milestone delivery to prevent site bottlenecks"
    ],
    solutionsDelivered: [
      "Substation transformers, HT panels, and automatic mains failure DG skids",
      "FM-200 gas suppression and sprinkler grid installation",
